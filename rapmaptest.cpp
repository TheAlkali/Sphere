...
int main()
{
	...
	T0.Reset();     T0.Start();
	system("rapmap quasimap -i ../rapmap-res/ref_index -1 dataset/srrdata/small_SRR5337025_1.fastq -2 dataset/srrdata/small_SRR5337025_2.fastq -o rapmap_mapped_reads.sam");
	T0.Stop();
